...
const menuItems: { href: string; title: string; description: string; icon: LucideIcon }[] = [
  ...
  { href: "/login", title: "Login", description: "Entrar ou criar conta real.", icon: LogIn },
  { href: "/configuracao", title: "Primeiro acesso", description: "Uso unico: criar a igreja e o primeiro administrador. Nao e a tela de ajustes.", icon: Building2 },
